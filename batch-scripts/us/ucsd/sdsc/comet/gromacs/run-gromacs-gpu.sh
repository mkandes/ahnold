...
#     multinode, GPU-accelerated, hybrid MPI + OpenMP molecular dynamics 
#     simulation with GROMACS [2] on SDSC's Comet supercomputer [3] in 
#     its 'gpu' resource partition.
#
# USAGE
#
...
#SBATCH --partition=gpu       # Request 4 p100 'gpu' nodes for up to 
#SBATCH --nodes=4             # 1 hour. Each node has 4 GPUs.
#SBATCH --ntasks-per-node=4 
#SBATCH --gres=gpu:p100:4
#SBATCH --time=01:00:00

#SBATCH --job-name=gromacs-gpu
#SBATCH --output=gromacs-gpu.o%j.%N
